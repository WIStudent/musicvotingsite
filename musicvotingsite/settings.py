"""
Django settings for musicvotingsite project.
...
SECRET_KEY = '479lhfrka01_i3fn0ibs%05t#+(7ep$i1j3_b$*$o)qf_r3db^'
...
ROOT_URLCONF = 'musicvotingsite.urls'

WSGI_APPLICATION = 'musicvotingsite.wsgi.application'
